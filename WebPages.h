...
WElement holosContents[] = {
    ...
    WHorizontalAlign(),
    WButton("Front Leia", "front_leia", []() { CommandEvent::process(F("HPF001")); }),
    WButton("Front Rainbow", "front_rainbow", []() { CommandEvent::process(F("HPF006")); }),
    WButton("Short Circuit", "front_short_circuit", []() { CommandEvent::process(F("HPF0070|10")); }),
    WButton("D0991", "front_d0991", []() { CommandEvent::process(F("HPF0991")); }),
    WButton("D0992", "front_d0992", []() { CommandEvent::process(F("HPF0992")); }),
    WButton("Front Off", "front_off", []() { CommandEvent::process(F("HPF0000")); }),
    WVerticalAlign(),
    WLabel("Rear Holo", "rearlabel"),
    WHorizontalAlign(),
    WButton("Rear Leia", "rear_leia", []() { CommandEvent::process(F("HPR001")); }),
    WButton("Rear Rainbow", "rear_rainbow", []() { CommandEvent::process(F("HPR006")); }),
    WButton("Short Circuit", "rear_short_circuit", []() { CommandEvent::process(F("HPR0070|10")); }),
    WButton("D0991", "rear_d0991", []() { CommandEvent::process(F("HPR0991")); }),
    WButton("D0992", "rear_d0992", []() { CommandEvent::process(F("HPR0992")); }),
    WButton("Rear Off", "rear_off", []() { CommandEvent::process(F("HPR0000")); }),
    WVerticalAlign(),
    WLabel("Top Holo", "toplabel"),
    WHorizontalAlign(),
    WButton("Top Leia", "top_leia", []() { CommandEvent::process(F("HPT001")); }),
    WButton("Top Rainbow", "top_rainbow", []() { CommandEvent::process(F("HPT006")); }),
    WButton("Short Circuit", "top_short_circuit", []() { CommandEvent::process(F("HPT0070|10")); }),
    WButton("D0991", "top_d0991", []() { CommandEvent::process(F("HPT0991")); }),
    WButton("D0992", "top_d0992", []() { CommandEvent::process(F("HPT0992")); }),
    WButton("Top Off", "top_off", []() { CommandEvent::process(F("HPT0000")); }),
    WVerticalAlign(),
    WLabel("All Holo", "alllabel"),
    WHorizontalAlign(),
    WButton("All Leia", "all_leia", []() { CommandEvent::process(F("HPA001")); }),
    WButton("All Rainbow", "all_rainbow", []() { CommandEvent::process(F("HPA006")); }),
    WButton("Short Circuit", "all_short_circuit", []() { CommandEvent::process(F("HPA0070|10")); }),
    WButton("D0991", "all_d0991", []() { CommandEvent::process(F("HPA0991")); }),
    WButton("D0992", "all_d0992", []() { CommandEvent::process(F("HPA0992")); }),
    WButton("All Off", "all_d0992", []() { CommandEvent::process(F("HPA0000")); }),
    WVerticalAlign(),
    WLabel("Manual HP Command", "manualholo"),
    WTextField("Command (e.g. HPA000|0)", "hpcommand",
        []()->String { return sHoloCommand; },
        [](String val) { sHoloCommand = val; }),
    WHorizontalAlign(),
    WButton("Send", "hpsend", []() {
        if (sHoloCommand.length() > 0)
        {
            CommandEvent::process(sHoloCommand.c_str());
        }
    }),
    WHorizontalAlign(),
    WButton("Back", "back", "/"),
